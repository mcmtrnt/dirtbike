"""
Django settings for dirtbikedeals project.
...
SECRET_KEY = '4$!k1*bhk+^vq(9t#^reo)lwh#1-%)8wx$)@=#v(h1$5(mygga'
...
ROOT_URLCONF = 'dirtbikedeals.urls'
...
WSGI_APPLICATION = 'dirtbikedeals.wsgi.application'
